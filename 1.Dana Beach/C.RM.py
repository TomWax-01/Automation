...
def click_parameters(report_name, save_path, file_name):
    ...
    try:
        ...
        pyautogui.moveTo(report_window.left + 420, report_window.top + 210, duration=0)
        pyautogui.click()
        time.sleep(0.2)
        pyautogui.click()
        time.sleep(0.2)
        pyautogui.moveTo(report_window.left + 165, report_window.top + 45, duration=0)
        pyautogui.click()
        time.sleep(0.2)
        ...
        # Fill parameters
        pyautogui.moveTo(report_window.left + 300, report_window.top + 115, duration=0)
        pyautogui.click()
        time.sleep(0.2)
        pyautogui.press('tab')
        pyautogui.press('backspace')
        pyautogui.write(yesterday.strftime('%d%m%y'))
...
if __name__ == "__main__":
    report_name = "R 0410 Reservation - Created By ..."  # Report window title
    save_path = "D:\\Daily_Chart\\Chart_Resources\\S25\\HRG"  # Target Folder
    file_name = "DB RM"  # Desired file name
