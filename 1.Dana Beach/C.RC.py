...
def click_parameters(report_name, save_path, file_name):
    ...
    try:
        ...
        pyautogui.moveTo(report_window.left + 300, report_window.top + 170, duration=0)
        pyautogui.click()
        time.sleep(0.2)
        pyautogui.click()
        time.sleep(0.2)
...
if __name__ == "__main__":
    report_name = "A 0101 Cancel reservation by date"  # Report window title
    save_path = "D:\\Daily_Chart\\Chart_Resources\\S25\\HRG"  # Target Folder
    file_name = "DB RC"  # Desired file name
